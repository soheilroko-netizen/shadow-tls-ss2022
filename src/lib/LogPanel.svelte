...
<style>
  ...
  .log-content::-webkit-scrollbar { width: 2px; }
  .log-content::-webkit-scrollbar-track { background: transparent; }
  .log-content::-webkit-scrollbar-thumb { background: rgba(245,158,11,0.08); border-radius: 2px; }
</style>
